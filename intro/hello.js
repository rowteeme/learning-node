...
http.createServer(function(request, response) {
	//calling createServer function, single paramter is a function with a request and response. 
...
// CTRL + C allows you to end the program gracefully in Terminal, unbinding from any ports it is listening on.
